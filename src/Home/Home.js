  ...
  const sliderArray = [
    {
      id: "1",
      src:
        "https://images-eu.ssl-images-amazon.com/images/G/31/AmazonVideo/2021/X-site/Multititle/Feb/EN/1500x600_Hero-Tall_NP._CB660400564_.jpg",
    },
    {
      id: "2",
      src:
    ...
    },
    {
      id: "3",
      src:
        "https://images-eu.ssl-images-amazon.com/images/G/31/img2020/fashion/WA_2020/StyleBazaar21/gateway/SB_PC_BUNK_50._CB660443097_.jpg",
    },
    {
      id: "4",
      src:
  ...
  return (
    <div className={styles.home}>
      <div className={styles.home__container}>
        <p className={styles.clone__text}>AMAZON CLONE BY:- VINAY MATTA</p>
        <SwiftSlider
          data={sliderArray}
          height={600}
          showDots={false}
        ...
        <div className={styles.homes}>
          <animated.div style={props} className={styles.home__row}>
            <Product
              id={"12cbe1"}
          ...
          <animated.div className={styles.home__row} style={props}>
            <Product
              id={"12cbe5"}
